...
namespace UnityEngine.InputSystem.Samples.RebindUI
{
    ...
    public class RebindActionUI : MonoBehaviour
    {
        ...
        [Tooltip("Optional bool field which allows you to OVERRIDE the action lable with your own text")]
        public bool m_OverRideActionLabel;

        [Tooltip("What text should be displayed for the action lablel?")]
        [SerializeField]
